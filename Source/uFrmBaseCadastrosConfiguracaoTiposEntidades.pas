unit uFrmBaseCadastrosConfiguracaoTiposEntidades;
...
type
  TFrmBaseCadastrosConfiguracaoTiposEntidades = class(TFrmBaseCadastrosConfiguracao)
...
var
  FrmBaseCadastrosConfiguracaoTiposEntidades: TFrmBaseCadastrosConfiguracaoTiposEntidades;
...
{ TFrmBaseCadastrosConfiguracaoTiposEntidades }

procedure TFrmBaseCadastrosConfiguracaoTiposEntidades.FiltraDados(ID_USUARIOS,
...
class procedure TFrmBaseCadastrosConfiguracaoTiposEntidades.Inicializa(
  ID_USUARIOS, ID_FORMULARIO: integer; wl_SQL: string);
begin
  with TFrmBaseCadastrosConfiguracaoTiposEntidades.Create(Application) do
  begin
...
procedure TFrmBaseCadastrosConfiguracaoTiposEntidades.qConfiguracoesAfterPost(
  DataSet: TDataSet);
begin
  inherited;
...
function TFrmBaseCadastrosConfiguracaoTiposEntidades.VerificaSeExisteConfiguracao(
